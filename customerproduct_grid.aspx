<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="customerproduct_grid.aspx.cs" Inherits="IssueRegister.customerproduct_grid" %>
    ...
    <div>
        <div style="height: 65px; width: 100%; background: #227a89; margin-top: 10px;">
            <table>
                <tr>
                    <td class="style6">
                        <asp:Label ID="lbluser" runat="server" Text="CUSTOMER PRODUCT LIST" Font-Bold="True"
            ...
            <tr>
                <td colspan="6" style="padding-top: 13px;">
                    <div id="Div1" style="width: 147%; min-height: 0px; max-height: 240px; height: 199px;">
                        ...
                        <div style="overflow: hidden; width: 129" onscroll="OnScrollDiv1(this)" id="Div3">
                            <asp:GridView ID="dg_Customerproduct" runat="server" DataKeyNames="CustomerID,productID,ProductName"
                                ShowHeaderWhenEmpty="true" ShowHeader="true" AlternatingRowStyle-CssClass="alt"
                                AutoGenerateColumns="False" Font-Bold="True" Height="50px" Width="959px" CssClass="mydatagrid"
                                PagerStyle-CssClass="pager" HeaderStyle-CssClass="header" RowStyle-CssClass="rows"
                                AllowPaging="True" OnSelectedIndexChanged="dg_Customerproduct_SelectedIndexChanged"
                                OnPageIndexChanging="dg_Customerproduct_PageIndexChanging">
                                <Columns>
